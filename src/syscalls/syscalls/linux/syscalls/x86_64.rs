use types::{int_t, uint_t, char_t, size_t, ulong_t};
...
syscall!(001, sys_write, uint_t, *char_t, size_t)
syscall!(002, sys_open, *char_t, int_t, int_t)
syscall!(003, sys_close, uint_t)
syscall!(004, sys_stat, *char_t, *mut stat)
syscall!(005, sys_fstat, uint_t, *mut stat)
syscall!(006, sys_lstat, *char_t, *mut stat)
syscall!(007, sys_poll, *mut poll_fd, uint_t, long_t)
...
syscall!(013, sys_rt_sigaction, int_t, *sigaction, *mut sigaction, size_t)
...
syscall!(018, sys_pwrite64, uint_t, *char_t, size_t, loff_t)
syscall!(019, sys_readv, ulong_t, *iovec, ulong_t)
syscall!(020, sys_writev, ulong_t, *iovec, ulong_t)
syscall!(021, sys_access, *char_t, int_t)
...
syscall!(049, sys_bind, int_t, *mut sokaddr, int_t)
...
syscall!(059, sys_execve, *char_t, **char_t, **char_t)
...
syscall!(076, sys_truncate, *char_t, long_t)
...
syscall!(080, sys_chdir, *char_t)
syscall!(081, sys_fchdir, uint_t)
syscall!(082, sys_rename, *char_t, *char_t)
syscall!(083, sys_mkdir, *char_t, int_t)
syscall!(084, sys_rmdir, *char_t)
syscall!(085, sys_creat, *char_t, int_t)
syscall!(086, sys_link, *char_t, *char_t)
syscall!(087, sys_unlink, *char_t)
syscall!(088, sys_symlink, *char_t, *char_t)
syscall!(089, sys_readlink, *char_t, *mut char_t, int_t)
syscall!(090, sys_chmod, *char_t, mode_t)
syscall!(091, sys_fchmod, uint_t, mode_t)
syscall!(092, sys_chown, *char_t, uid_t, git_t)
syscall!(093, sys_fchown, uint_t, uid_t, git_t)
syscall!(094, sys_lchown, *char_t, uid_t, git_t)
...
syscall!(114, sys_setregid, git_t, gid_t)
...
syscall!(120, sys_getresgid, *mut git_t, *mut git_t, *mut git_t)
...
syscall!(126, sys_capset, cap_user_header_t, *cap_user_data_t)
syscall!(127, sys_rt_sigpending, *mut sigset_t, size_t)
syscall!(128, sys_rt_sigtimedwait, *sigset_t, *mut siginfo_t, *timespec, size_t)
syscall!(129, sys_rt_sigqueueinfo, pid_t, int_t, *mut siginfo_t)
syscall!(130, sys_rt_sigsuspend, *mut sigset_t, size_t)
syscall!(131, sys_sigaltstack, *stack_t, *mut stack_t)
syscall!(132, sys_utime, *mut char_t, *mut utimbuf)
syscall!(133, sys_mknod, *char_t, int_t, uint_t)
// syscall!(134, sys_uselib, NOT)
syscall!(135, sys_personality, uint_t)
syscall!(136, sys_ustat, uint_t, *mut ustat)
syscall!(137, sys_statfs, *char_t, *mut statfs)
...
syscall!(155, sys_pivot_root, *char_t, *char_t)
syscall!(156, sys__sysctl, *mut __sysctl_args)
syscall!(157, sys_prctl, int_t, ulong_t, ulong_t, ulong_t, (), ulong_t)
syscall!(158, sys_arch_prctl, *mut task_struct, int_t, *mut ulong_t)
syscall!(159, sys_adjtimex, *mut timex)
syscall!(160, sys_setrlimit, uint_t, *mut rlimit)
syscall!(161, sys_chroot, *char_t)
syscall!(162, sys_sync)
syscall!(163, sys_acct, *char_t)
...
syscall!(166, sys_umount2, *char_t, int_t)
syscall!(167, sys_swapon, *char_t, int_t)
syscall!(168, sys_swapoff, *char_t)
...
syscall!(175, sys_init_module, *mut void_t, ulong_t, *char_t)
syscall!(176, sys_delete_module, *chat, uint_t)
// syscall!(177, sys_get_kernel_syms, REMOVED IN Linux 2.)
// syscall!(178, sys_query_module, REMOVED IN Linux 2.)
syscall!(179, sys_quotactl, uint_t, *char_t, qid_t, *mut void_t)
...
syscall!(188, sys_setxattr, *char_t, *char_t, *void_t, size_t, int_t)
syscall!(189, sys_lsetxattr, *char_t, *char_t, *void_t, size_t, int_t)
syscall!(190, sys_fsetxattr, int_t, *char_t, *void_t, size_t, int_t)
syscall!(191, sys_getxattr, *char_t, *char_t, *mut void_t, size_t)
syscall!(192, sys_lgetxattr, *char_t, *char_t, *mut void_t, size_t)
syscall!(193, sys_fgetxattr, int_t, *har, *mut void_t, size_t)
syscall!(194, sys_listxattr, *char_t, *mut char_t, size_t)
syscall!(195, sys_llistxattr, *char_t, *mut char_t, size_t)
syscall!(196, sys_flistxattr, int_t, *mut char_t, size_t)
syscall!(197, sys_removexattr, *char_t, *char_t)
syscall!(198, sys_lremovexattr, *char_t, *char_t)
syscall!(199, sys_fremovexattr, int_t, *char_t)
syscall!(200, sys_tkill, pid_t, ing)
...
syscall!(220, sys_semtimedop, int_t, *mut sembuf, uint_t, *timespec)
syscall!(221, sys_fadvise64, int_t, loff_t, size_t, int_t)
syscall!(222, sys_timer_create, *clockid_t, *mut sigevent, *mut timer_t)
syscall!(223, sys_timer_settime, timer_t, int_t, *itimerspec, *mut itimerspec)
...
syscall!(227, sys_clock_settime, *clockid_t, *timespec)
syscall!(228, sys_clock_gettime, *clockid_t, *mut timespec)
syscall!(229, sys_clock_getres, *clockid_t, *mut timespec)
syscall!(230, sys_clock_nanosleep, *clockid_t, int_t, *timespec, *mut timespec)
...
syscall!(240, sys_mq_open, *char_t, int_t, mode_t, *mut mq_attr)
syscall!(241, sys_mq_unlink, *char_t)
syscall!(242, sys_mq_timedsend, mqd_t, *char_t, size_t, uint_t, *timespec)
syscall!(243, sys_mq_timedreceive, mqd_t, *mut char_t, size_t, *mut uint_t, *timespec)
syscall!(244, sys_mq_notify, mqd_t, *sigevent)
syscall!(245, sys_mq_getsetattr, mqd_t, *mq_attr, *mut mq_attr)
syscall!(246, sys_kexec_load, ulong_t, ulong_t, *mut kexec_segment, ulong_t)
syscall!(247, sys_waitid, int_t, pid_t, *mut siginfo, int_t, *mut rusage)
syscall!(248, sys_add_key, *char_t, *char_t, *void_t, size_t)
syscall!(249, sys_request_key, *char_t, *char_t, *char_t, key_serial_t)
...
syscall!(254, sys_inotify_add_watch, int_t, *char_t, u32)
syscall!(255, sys_inotify_rm_watch, int_t, i32)
syscall!(256, sys_migrate_pages, pid_t, ulong_t, *ulong_t, *ulong_t)
syscall!(257, sys_openat, int_t, *char_t, int_t, int_t)
syscall!(258, sys_mkdirat, int_t, *char_t, int_t)
syscall!(259, sys_mknodat, int_t, *char_t, int_t, uint_t)
syscall!(260, sys_fchownat, int_t, *char_t, uid_t, gid_t, int_t)
syscall!(261, sys_futimesat, int_t, *char_t, *mut timeval)
syscall!(262, sys_newfstatat, int_t, *char_t, *mut stat, int_t)
syscall!(263, sys_unlinkat, int_t, *char_t, int_t)
syscall!(264, sys_renameat, int_t, *char_t, int_t, *char_t)
syscall!(265, sys_linkat, int_t, *char_t, int_t, *char_t, int_t)
syscall!(266, sys_symlinkat, *char_t, int_t, *char_t)
syscall!(267, sys_readlinkat, int_t, *char_t, *mut char_t, int_t)
syscall!(268, sys_fchmodat, int_t, *char_t, mode_t)
syscall!(269, sys_faccessat, int_t, *char_t, int_t)
syscall!(270, sys_pselect6, int_t, *mut fd_set, *mut fd_set, *mut fd_set, *mut timespec,
         *mut void_t)
syscall!(271, sys_ppoll, *mut pollfd, uint_t, *mut timespec, *sigset_t, size_t)
...
syscall!(278, sys_vmsplice, int_t, *iovec, ulong_t, uint_t)
syscall!(279, sys_move_pages, pid_t, ulong_t, *mut *void_t, *int_t, *mut int_t, int_t)
syscall!(280, sys_utimensat, int_t, *char_t, *mut timespec, int_t)
syscall!(281, sys_epoll_pwait, int_t, *mut epoll_event, int_t, int_t, *sigset_t, size_t)
...
syscall!(286, sys_timerfd_settime, int_t, int_t, *itimerspec, *mut itimerspec)
...
syscall!(295, sys_preadv, ulong_t, *iovec, ulong_t, ulong_t, ulong_t)
syscall!(296, sys_pwritev, ulong_t, *iovec, ulong_t, ulong_t, ulong_t)
syscall!(297, sys_rt_tgsigqueueinfo, pid_t, pid_t, int_t, *mut siginfo_t)
syscall!(298, sys_perf_event_open, *mut perf_event_attr, pid_t, int_t, int_t, ulong_t)
...
syscall!(302, sys_prlimit64, pid_t, uint_t, *rlimit64, *mut rlimit64)
syscall!(303, sys_name_to_handle_at, int_t, *char_t, *mut file_handle, *mut int_t, int_t)
syscall!(304, sys_open_by_handle_at, int_t, *char_t, *mut file_handle, *mut int_t, int_t)
...
syscall!(310, sys_process_vm_readv, pid_t, *iovec, ulong_t, *iovec, ulong_t, ulong_t)
syscall!(311, sys_process_vm_writev, pid_t, *iovec, ulong_t, *iovcc, ulong_t, ulong_t)
