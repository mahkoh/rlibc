...
syscall!(092, sys_chown, *char_t, uid_t, gid_t)
syscall!(093, sys_fchown, uint_t, uid_t, gid_t)
syscall!(094, sys_lchown, *char_t, uid_t, gid_t)
...
syscall!(176, sys_delete_module, *char_t, uint_t)
...
syscall!(193, sys_fgetxattr, int_t, *char_t, *mut void_t, size_t)
...
syscall!(311, sys_process_vm_writev, pid_t, *iovec, ulong_t, *iovec, ulong_t, ulong_t)
